...
const templateDir = require( 'path' ).resolve( __dirname, '../templates' );
        ...
        if ( scope.flavor === "remove" ) {
          ...
          fs.stat(templateDir + '/' + scope.flavor, function(err, stats) {
            ...
            ['add', 'create', 'destroy', 'find', 'findone', 'message', 'messageone', 'populate', 'remove', 'update'].forEach(function (blueprint) {
                fs.writeFileSync(inRootBP + '/' + blueprint + '.js', 'const _ = require("lodash");\nconst _super = require(\'sails-generate-jsonapi-blueprints/templates/' + scope.flavor + '/api/blueprints/' + blueprint + '.js\');\n_.merge(exports, _super);\n\n_.merge(exports, {\n  /* Extend or override core functions */\n}');
            });

            fs.writeFileSync(inRootResponse, 'const _ = require("lodash");\nconst _super = require(\'sails-generate-jsonapi-blueprints/templates/' + scope.flavor + '/api/responses/jsonapi_ok.js\');\n_.merge(exports, _super);\n\n_.merge(exports, {\n  /* Extend or override core functions */\n}');

            fs.writeFileSync(inRootSrvc, 'const _ = require("lodash");\nconst _super = require(\'sails-generate-jsonapi-blueprints/templates/' + scope.flavor + '/api/services/jsonapiService.js\');\n_.merge(exports, _super);\n\n_.merge(exports, {\n  /* Extend or override core functions */\n}');
